...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/install`,                       lastModified: now, changeFrequency: "weekly",  priority: 1.0 },
    { url: `${BASE_URL}/plans`,                         lastModified: now, changeFrequency: "weekly",  priority: 1.0 },
    { url: `${BASE_URL}/extensions`,                    lastModified: now, changeFrequency: "weekly",  priority: 0.95 },
    { url: `${BASE_URL}/linux-modes`,                   lastModified: now, changeFrequency: "weekly",  priority: 0.95 },
    { url: `${BASE_URL}/what-is-new`,                   lastModified: now, changeFrequency: "weekly",  priority: 0.9 },
    // New v4.4.0 feature pages — high SEO value (long-tail keywords)
    { url: `${BASE_URL}/features/devsec`,               lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/features/vibe-hack`,            lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/features/chain`,                lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/features/red-team`,             lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    // Docs
    ...
    { url: `${BASE_URL}/model`,                         lastModified: now, changeFrequency: "monthly", priority: 0.8 },
