...
const plans = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Full 30-tool recon chain (Linux)", included: true },
      { text: "Full 40-tool hunt engine (Linux)", included: true },
      { text: "JS deep analysis (SecretFinder, LinkFinder, jsluice)", included: true },
      { text: "CMSeeK + retire.js (CMS + vuln lib detection)", included: true },
      ...
      { text: "HTML report generation", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "--incremental + --monitor mode", included: true },
      { text: "Diff tracking + HTML reports + hotlist", included: true },
      { text: "JS deep analysis (all 7 tools)", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "--incremental + --monitor + diff tracking", included: true },
      { text: "HTML + PDF reports + hotlist + asset store", included: true },
      { text: "JS deep analysis (all 7 tools + sourcemapper)", included: true },
...
const comparisonRows = [
  ...
  { category: "Recon", icon: <Globe size={14} />, feature: "JS deep analysis (SecretFinder/jsluice)", free: false, starter: true, pro: true, elite: true },
  { category: "Recon", icon: <Globe size={14} />, feature: "CMSeeK + retire.js", free: false, starter: true, pro: true, elite: true },
  { category: "Recon", icon: <Globe size={14} />, feature: "--incremental mode", free: false, starter: false, pro: true, elite: true },
