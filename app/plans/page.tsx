...
const plans = [
  {
    ...
    monthlyUSD: "$0",
    annualUSD: "$0",
    description: "AI chat + CBM Code (own keys). Works on Linux, Windows, macOS.",
    badge: null,
    offer: null,
    features: [
      "20 requests/day",
      "AI security chat (all platforms)",
      "CBM Code — bring your own API key",
      "Basic scan & exploit guides",
      "/scan /osint /cve /payload (all OS)",
      "1 device",
      "Community support",
    ],
  ...
  },
  {
    ...
    description: "Unlimited recon, hunt, CBM Code with web search + image gen + PoC reports.",
    badge: "Most popular",
    offer: null,
    features: [
      "200 requests/day",
  ...
  },
  {
    ...
    monthlyUSD: "$29",
    annualUSD: "$290",
    description: "Unlimited everything — CBM Code GPT-5/Claude, Abhimanyu, full OMEGA pipeline, PDF reports.",
    badge: null,
    offer: null,
    features: [
      "Unlimited requests",
      "CBM Code with GPT-5 + Claude Opus 4",
...
const comparisonRows = [
  ...
  ["AI chat",                   "✓",        "✓",               "✓",                "✓"],
  ["CBM Code",                  "Own keys", "Managed keys",    "+ web/img",        "GPT-5/Claude"],
  ...
  ["Hunt workflow",             "—",        "5 targets",       "Full 30 tools",    "Full 30 tools"],
...
const faqs = [
  ...
  },
  {
    ...
    body: "Core chat and CBM Code work everywhere (Windows, macOS, Linux). OMEGA plan mode, recon, hunt, and Abhimanyu require Linux/Kali — these use 50+ security tools that are Linux-native.",
  },
  {
