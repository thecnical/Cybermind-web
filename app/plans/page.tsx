...
const plans = [
  {
    ...
    monthlyUSD: "$0",
    annualUSD: "$0",
    description: "AI chat + Vibe Coder (own keys) on all your devices. No credit card needed.",
    badge: null,
    offer: null,
    features: [
      "20 requests/day",
      "AI chat on all devices",
      "Vibe Coder (bring your own API key)",
  ...
  },
  {
    ...
    monthlyUSD: "$4",
    annualUSD: "$40",
    description: "Full chat + Vibe Coder + 5 recon/hunt/Abhimanyu targets per month.",
    badge: "🔥 Best value",
    offer: null,
    features: [
      "50 requests/day",
      "AI chat on all devices",
      "Vibe Coder (managed keys)",
  ...
  },
  {
    ...
    description: "Unlimited recon, hunt, Vibe Coder with web search + image gen.",
    badge: "Most popular",
    offer: `Limited offer — save 23% until ${PROMO_END}`,
    features: [
      "200 requests/day",
      "Vibe Coder + web search + image gen",
  ...
  },
  {
    ...
    monthlyUSD: "$29",
    annualUSD: "$290",
    description: "Unlimited everything — Vibe Coder with GPT-5/Claude Opus, Abhimanyu, PDF reports.",
    badge: null,
    offer: null,
    features: [
      "Unlimited requests",
      "Vibe Coder with GPT-5 + Claude Opus 4",
...
const comparisonRows = [
  ...
  ["AI chat",            "✓",        "✓",           "✓",         "✓"],
  ["Vibe Coder",         "Own keys", "Managed keys","+ web/img", "GPT-5/Claude"],
